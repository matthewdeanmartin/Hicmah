...
GO
INSERT [dbo].[aspnet_Applications] ([ApplicationName], [LoweredApplicationName], [ApplicationId], [Description]) VALUES (N'/', N'/', N'a85a22fc-bd4e-433c-ba32-55900e7ca2fa', NULL)
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE TABLE [dbo].[hicmah_dates](
	...
	[month] [tinyint] NULL,
	[day] [tinyint] NULL,
	[first_of_month] [smalldatetime] NULL,
	[fiscal_year] [smallint] NULL,
	[fiscal_quarter] [tinyint] NULL,
	[calendar_quarter] [tinyint] NULL,
	[week_number] [tinyint] NULL,
	[workday_weekend] [tinyint] NULL,
	[holiday] [bit] NULL,
	[short_month] [nvarchar](50) NULL,
	[long_month] [nvarchar](50) NULL,
	[short_year_month] [nvarchar](50) NULL,
	[long_year_month] [nvarchar](50) NULL,
	[short_day] [nvarchar](50) NULL,
	[long_day] [nvarchar](50) NULL,
	[day_of_week] [nvarchar](50) NULL,
	[long_date] [nvarchar](150) NULL,
	[sortable_date] [nvarchar](100) NULL,
	[usortable_date] [nvarchar](100) NULL,
	[rfc1123_date] [nvarchar](100) NULL,
 CONSTRAINT [PK_hicmah_dates] PRIMARY KEY CLUSTERED 
(
	[date_id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[hicmah_cache](
	[cache_id] [int] IDENTITY(1,1) NOT NULL,
	[parameters] [nvarchar](1000) NULL,
	[cachedResults] [nvarchar](max) NULL,
	[expirationDate] [datetime] NULL,
	[queryName] [varchar](100) NULL,
	[insertDate] [datetime] NULL,
 CONSTRAINT [PK_hicmah_cache] PRIMARY KEY CLUSTERED 
(
	[cache_id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[himcah_resolutions](
...
GO
SET IDENTITY_INSERT [dbo].[hicmah_users] ON
INSERT [dbo].[hicmah_users] ([user_id], [user], [first_use], [last_use], [current_browser], [current_resolution]) VALUES (0, N'None provided', NULL, NULL, NULL, NULL)
SET IDENTITY_INSERT [dbo].[hicmah_users] OFF
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
SET IDENTITY_INSERT [dbo].[hicmah_user_agents] ON
INSERT [dbo].[hicmah_user_agents] ([user_agent_id], [user_agent], [date_first_seen]) VALUES (0, N'None provided', NULL)
SET IDENTITY_INSERT [dbo].[hicmah_user_agents] OFF
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
SET IDENTITY_INSERT [dbo].[hicmah_urls] ON
INSERT [dbo].[hicmah_urls] ([url_id], [url], [host_name], [port], [absolute_path], [query]) VALUES (0, N'None provided', NULL, NULL, NULL, NULL)
SET IDENTITY_INSERT [dbo].[hicmah_urls] OFF
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[hicmah_times]    Script Date: 12/10/2011 18:06:39 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[hicmah_times](
	[time_id] [smallint] NOT NULL,
	[twenty_four_hour] [tinyint] NULL,
	[hour] [tinyint] NULL,
	[minute] [tinyint] NULL,
	[second] [tinyint] NULL,
	[AM_PM] [nvarchar](4) NULL,
	[shift] [tinyint] NULL,
	[short_time] [nvarchar](100) NULL,
	[long_time] [nvarchar](100) NULL,
	[three_shift] [tinyint] NULL,
	[is_business_hours] [bit] NULL,
 CONSTRAINT [PK_hicmah_times] PRIMARY KEY CLUSTERED 
(
	[time_id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[hicmah_time_zones](
	[time_zone_id] [int] NOT NULL,
	[olson_zone] [nvarchar](150) NULL,
	[windows_zone] [nvarchar](150) NULL,
	[offset] [nchar](10) NULL,
	[uses_daylight_savings] [bit] NULL,
 CONSTRAINT [PK_himah_time_zones] PRIMARY KEY CLUSTERED 
(
	[time_zone_id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[hicmah_servers](
	[server_id] [int] NOT NULL,
	[server_name] [nchar](10) NULL,
	[os_name] [nvarchar](100) NULL,
	[os_platform] [nvarchar](100) NULL,
	[os_version] [nvarchar](100) NULL,
	[os_env_version] [nvarchar](150) NULL,
	[server_cpu_count] [smallint] NULL,
	[server_culture] [nvarchar](20) NULL,
	[memory_bytes] [int] NULL,
	[app_version_by_file_date] [datetime] NULL,
	[app_version_by_file_size] [int] NULL,
 CONSTRAINT [PK_hicmah_servers] PRIMARY KEY CLUSTERED 
(
	[server_id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
) ON [PRIMARY]
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[hicmah_request_types](
...
SET ANSI_PADDING OFF
GO
INSERT [dbo].[hicmah_invoker] ([invoker_id], [invoker]) VALUES (1, N'HttpHandler')
INSERT [dbo].[hicmah_invoker] ([invoker_id], [invoker]) VALUES (2, N'HttpModule')
INSERT [dbo].[hicmah_invoker] ([invoker_id], [invoker]) VALUES (3, N'Code Invoke')
INSERT [dbo].[hicmah_invoker] ([invoker_id], [invoker]) VALUES (4, N'ASMX Invoke')
INSERT [dbo].[hicmah_invoker] ([invoker_id], [invoker]) VALUES (5, N'WCF Invoke')
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  Table [dbo].[hicmah_hits]    Script Date: 12/10/2011 18:08:02 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[hicmah_hits](
	...
	[utc_date] [smalldatetime] NULL,
	[date_id] [int] NULL,
	[time_id] [smallint] NULL,
	[client_date_id] [int] NULL,
	[client_time_id] [smallint] NULL,
...
CREATE NONCLUSTERED INDEX [missing_index_hicmah_hits_date_full_url] ON [dbo].[hicmah_hits] 
(
	[hit_date] ASC
)
INCLUDE ( [full_url_id]) WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [missing_index_hicmah_hits_Date_invoker] ON [dbo].[hicmah_hits] 
(
	[hit_date] ASC
)
INCLUDE ( [invoker_id]) WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [missing_index_hicmah_hits_Date_request_type] ON [dbo].[hicmah_hits] 
(
	[hit_date] ASC
)
INCLUDE ( [request_type_id]) WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [missing_index_hicmah_hits_Date_user_agent] ON [dbo].[hicmah_hits] 
(
	[hit_date] ASC
)
INCLUDE ( [user_agent_id]) WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [missing_index_hicmah_hits_date_user_name] ON [dbo].[hicmah_hits] 
(
	[hit_date] ASC
)
INCLUDE ( [user_name_id]) WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [missing_index_hicmah_hits_status_code_user] ON [dbo].[hicmah_hits] 
(
	[status_code] ASC
)
INCLUDE ( [user_name_id]) WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
...
GO
INSERT [dbo].[aspnet_Users] ([ApplicationId], [UserId], [UserName], [LoweredUserName], [MobileAlias], [IsAnonymous], [LastActivityDate]) VALUES (N'a85a22fc-bd4e-433c-ba32-55900e7ca2fa', N'1cf29b6f-9826-4d80-bf77-ee7552464574', N'mmartin', N'mmartin', NULL, 0, CAST(0x00009F9C010301DC AS DateTime))
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER OFF
GO
...
GO
INSERT [dbo].[aspnet_Membership] ([ApplicationId], [UserId], [Password], [PasswordFormat], [PasswordSalt], [MobilePIN], [Email], [LoweredEmail], [PasswordQuestion], [PasswordAnswer], [IsApproved], [IsLockedOut], [CreateDate], [LastLoginDate], [LastPasswordChangedDate], [LastLockoutDate], [FailedPasswordAttemptCount], [FailedPasswordAttemptWindowStart], [FailedPasswordAnswerAttemptCount], [FailedPasswordAnswerAttemptWindowStart], [Comment]) VALUES (N'a85a22fc-bd4e-433c-ba32-55900e7ca2fa', N'1cf29b6f-9826-4d80-bf77-ee7552464574', N'X9f1UDB42f6U0EPbHNsRNk7XVe0=', 1, N'7eyGXDuMiQsUHxhZp86jdw==', NULL, N'matthewdeanmartin', N'matthewdeanmartin', NULL, NULL, 1, 0, CAST(0x00009F9C010301DC AS DateTime), CAST(0x00009F9C010301DC AS DateTime), CAST(0x00009F9C010301DC AS DateTime), CAST(0xFFFF2FB300000000 AS DateTime), 0, CAST(0xFFFF2FB300000000 AS DateTime), 0, CAST(0xFFFF2FB300000000 AS DateTime), NULL)
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER OFF
GO
