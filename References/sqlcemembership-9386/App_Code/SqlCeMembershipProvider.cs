...
namespace ErikEJ
{
    ...
    public sealed class SqlCeMembershipProvider : MembershipProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (ConnectionStringSettings == null || Str.IsNullOrWhiteSpace(ConnectionStringSettings.ConnectionString))
            {
                 ...
                 out MembershipCreateStatus status)
        {
            ...
            if (RequiresUniqueEmail && !Str.IsNullOrWhiteSpace(GetUserNameByEmail(email)))
            {
            ...
            if (u == null)
            {
                ...
                passwordQuestion = Str.IsNullOrWhiteSpace(passwordQuestion) ? string.Empty : passwordQuestion;
                passwordAnswer = Str.IsNullOrWhiteSpace(passwordAnswer) ? string.Empty : passwordAnswer;
        ...
        {
            if (Str.IsNullOrWhiteSpace(reader.GetString(1))) return null;
        ...
        public override void UpdateUser(MembershipUser user)
        {
            ...
            if (RequiresUniqueEmail)
            {
                ...
                if (!Str.IsNullOrWhiteSpace(userName) && !userName.Equals(user.UserName, StringComparison.InvariantCultureIgnoreCase))
        ...
        {
            if (Str.IsNullOrWhiteSpace(oldUserName))
                throw new ArgumentException("Parameter is null or empty", "oldUserName");
            if (Str.IsNullOrWhiteSpace(newUserName))
       ...
       /// <param name="newConnStr"></param>
        ...
        {
            if (Str.IsNullOrWhiteSpace(oldConnStr))
                throw new ArgumentException("Parameter cannot be null or empty", "oldConnStr");

            if (Str.IsNullOrWhiteSpace(newConnStr))
